      ...
      <div className="bg-overlay-2 absolute h-full w-full  md:max-w-[75%]">
        <div className="relative h-full w-full">
          <div className="content-wrapper absolute inset-center-y md:pl-5 xl:pl-[120px] md-down:h-full md:max-w-[80%] flex flex-col md:gap-10">
            <h4 className="md-down:h-full md-down:pt-12 md-down:text-center bg-overlay-title h2">Quiénes somos</h4>
            <div className="flex flex-col gap-10 bg-overlay-copy md-down:pt-20 md-down:pb-10 md-down:px-5 p-text">
              <p>
              ...
              <Link
                ...
                className="btn btn-yellow w-fit md-down:w-full md:px-[24px] md:py-[14px] button"
              >
                LEER MÁS
              </Link>
            </div>
